...
const CodeEditorForm = () => {
    ...
    useEffect(() => {
        // 처음에는 optimizeCategory 값을 false로 설정
    ...
    useEffect(() => {
        if (pipeOptimize && pipeOptimize.optimizeCategory) {
            const { isMerged, isChangedOrder } = pipeOptimize.optimizeCategory;
                ...
                <div>
                    <div className="pb-5">
                        ...
                        <div className="float-right flex pt-2">
                            <div className="pr-2">
                                {isOptimizable ? (
                                    <button>최적화가 발생하였습니다</button>
                                ) : (
                                    <button>최적화가 발생하지 않았습니다</button>
                                )}
                            </div>
